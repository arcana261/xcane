 ...
 */
 ...
 /**
  * @typedef XCaneAjaxOptions
  * @desc represents set of options that are passed to Ajax caller
  * @type {object}
  * @property {string} url - resource url
  * @property {string=} method - HTTP method to use, default is **get**
  * @property {*=} data - data to post or as query string if method is GET
  * @property {boolean=} json - prefer json
  * @property {boolean=} xml - prefer xml
  * @property {boolean=} yaml - prefer yaml
  * @property {boolean=} form - prefer form (application/x-www-form-urlencoded)
  * @property {boolean=} multipart - prefer multipart form (multipart/form-data)
  * @property {boolean|*} [query] - prefer query string or pass more parameters
  * as query string.
  * @property {*=} headers - HTTP headers to send
  * @property {{user: string, pass: string}|{bearer: string}} [auth] -
  * authentication information
  * @property {boolean=} resolveWithFullResponse - set to true if you wish to
  * receive full response generated by server
  */
