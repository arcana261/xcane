...
class XCaneTask {
   ...
   * @param {ES6Generator<Promise>} fn - the generator task function
   * @return {PromisifiedMethod} - a promise which is resolved once task
   * gets completed.
   */
  static from(fn) {
  ...
  /**
   * @desc spawns task from generator yielding promises
   * @param {ES6Generator<Promise>} fn - generator function
   * @return {Promise} - fulfils when execution is done
   */
  static spawn(fn) {
    return XCaneTask.from(fn)();
  }
}
